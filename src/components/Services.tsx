...
const services: Service[] = [
  {
    ...
    imageAlt: 'Website design mockup on screen',
    accentColor: '#4F8EF7',
    tag: 'Most Popular',
    title: 'Website Design',
    benefit: 'A website that looks premium and builds trust in seconds.',
    features: [
  ...
  },
  {
    ...
    imageAlt: 'Developer writing code on laptop',
    accentColor: '#22D3EE',
    tag: 'Built To Scale',
    title: 'Website Development',
    benefit: 'Fast, reliable, and built to grow with your business.',
    features: [
      'Clean, scalable code (React / Next.js)',
  ...
  },
  {
    ...
    imageAlt: 'Logo and brand identity mockup',
    accentColor: '#F472B6',
    tag: 'Brand Identity',
    title: 'Logo Design',
    benefit: 'A logo that makes your brand instantly recognizable.',
    features: [
      '3 unique concepts to choose from',
      'Unlimited revisions until you love it',
      'Full brand kit — colors, fonts & files',
    ],
    cta: 'See How It Works',
  },
  {
